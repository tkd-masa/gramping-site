...
<template>
    <header class="header">
        <div class="header_inner">
            <div class="head_fix">
                <div class="logo">
                    <router-link to="/HOME"><img src="../assets/img/logo.svg" alt=""></router-link>
                </div>
                <!--ハンバーガーメニュー-->
            ...
            <nav class="header_nav" v-bind:class="{'is_active' : open }">
                <ul class="header_nav_list">
                    <li class="header_nav_item" v-for="item in items" :key="item.id">
                        <router-link :to="item.link" class="header_nav_item_link" v-on:click="open=false">{{ item.itemName }}<div class="header_nav_item_ja">{{ item.itemName_ja }}</div></router-link>
                    </li>
                </ul>
            </nav>
        </div>
